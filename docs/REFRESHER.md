...
**The router works; the experts never have.** Five designs now, and
`expert_intervention.py` gives the same verdict for all of them: switching
**every expert off** changes mAP by 0.001-0.002 on every condition, and forcing
the wrong expert costs nothing. The block is a dense model carrying an expensive
unused branch. The best model in the project is the plain dense one.

**Final verdict and recommendation: `CONCLUSION-residual-moe.md`.**
Benchmark and cost tables: `STATUS-2026-09.md`.
...
| **final verdict** | **`docs/CONCLUSION-residual-moe.md`** |
| benchmark + cost | `docs/STATUS-2026-09.md` |
| expert loss literature | `docs/research-expert-losses.md` |
