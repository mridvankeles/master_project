...
The next work is expert **diversity**, not the router. Open hypothesis: 40-epoch
arms are less collapsed than the 100-epoch one, so the collapse may be a
late-training effect that the static priors delay but do not prevent.
